          ...
          <div class="container">
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                ...
                <li><a href="#section3">My Education</a></li>
            ...
            <div class="social-network">
              <ul class="soial-icons">
                <li>
                  <a href="https://www.linkedin.com/in/kimberly-hogeveen/"><i class="fa fa-linkedin"></i></a>
                </li>
                <li>
                  <a href="https://github.com/kimmieee2003"><i class="fa fa-github-square"></i></a>
                </li>
                ...
                <form id="contact" action="" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <fieldset>
                        <form method="POST">
                          <input type="submit" name="submit" type="submit" id="form-submit" class="button">
                            Send Message
                          </input>
                        </form>
...
if (isset($_POST['submit'])) {
  ...
  $message = $_POST['message'];
    ...
    $textpersoon = "Bedankt voor het versturen van uw bericht.";
    
    $emailmij = "kimberly.hogeveen@gmail.com";
    
    // mail($emailboyd,"vragenformulier",$textboyd);
    mail($email,"bericht",$textpersoon);
    mail($emailmij, $subject, $textmij);
  }
?>
